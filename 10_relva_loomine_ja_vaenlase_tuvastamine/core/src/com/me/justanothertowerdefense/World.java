...
public class World {
    ...
    public void createTower(TowerType towerType, Vector2 position) {
        ...
        towers.add(TowerFactory.makeTower(towerType, towerGuidanceSystem, position));

    }

    public void createRocket(RocketType rocketType, Vector2 position, Enemy target, TowerGuidanceSystem towerGuidanceSystem) {
        rockets.add(RocketFactory.makeRocket(rocketType, position, target, towerGuidanceSystem));
    }
    ...
    public void removeRocket(Rocket rocket) { rockets.remove(rocket); }
